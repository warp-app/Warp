<script lang="ts">
	...
	let themeCSS: string;
	$: themeCSS = `<style>body {--gray1: ${colorScheme.gray1}; --gray2: ${colorScheme.gray2}; --gray4: ${colorScheme.gray4}; --gray6: ${colorScheme.gray6}; --gray8: ${colorScheme.gray8}; --gray9: ${colorScheme.gray9}; --gray11: ${colorScheme.gray11}; --gray12: ${colorScheme.gray12}; --shadow: rgba(0, 0, 0, 0.2); --font: "Inter";}</style>`;
</script>
